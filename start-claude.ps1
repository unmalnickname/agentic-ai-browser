# Agentic AI Browser - Claude Launcher
# This script sets Claude as the LLM provider and starts the browser automation

# Display startup message
Write-Host "Starting Agentic AI Browser with Claude as the LLM provider..." -ForegroundColor Cyan
Write-Host "Make sure you have set your CLAUDE_API_KEY in the .env file!" -ForegroundColor Yellow
